...
                    </EditItemTemplate>  
        ...
        <asp:Panel ID="Panel1" runat="server">
            ...
            <br />
            <asp:TextBox ID="PhoneNumber" runat="server" TextMode="SingleLine" dir="rtl"></asp:TextBox>
            ...
            <br />
            <asp:TextBox ID="EmergencyPhoneNumber" runat="server" TextMode="SingleLine" dir="rtl"></asp:TextBox>
            ...
            <br />
            <asp:TextBox ID="FName" runat="server" TextMode="SingleLine" dir="rtl"></asp:TextBox>
            ...
            <br />
            <asp:TextBox ID="LName" runat="server" TextMode="SingleLine" dir="rtl"></asp:TextBox>
            ...
            <br />
            <asp:TextBox ID="HomeAdress" runat="server" TextMode="SingleLine" dir="rtl"></asp:TextBox>
            ...
            <br />
            <asp:DropDownList ID="HomeCity" runat="server" dir="rtl"></asp:DropDownList>
            ...
            <br />
            <asp:TextBox ID="Email" runat="server" TextMode="Email" dir="rtl"></asp:TextBox>
