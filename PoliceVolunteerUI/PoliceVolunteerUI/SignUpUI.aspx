...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="text-align: center" class="container-fluid">
        ...
        <div class="form-group">
            ...
            <asp:RegularExpressionValidator ID="IDRegularExpressionV" runat="server" ErrorMessage="אורך תעודת זהות לא מתאים" ValidationGroup="SignIn" ValidationExpression="\d{9}" ControlToValidate="IDIN"></asp:RegularExpressionValidator>
