...
namespace PoliceVolnteerBL
{
    public class ValidityTypeBL
    {
        ...
        public ValidityTypeBL(int ValidityCode)
        {
            ...
            DataRow dr = ValidityTypesDAL.GetTable(new FieldValue<ValidityTypesDALField>(ValidityTypesDALField.ValidityCode, ValidityCode.ToString(), FieldType.Number)).Tables[0].Rows[0];
