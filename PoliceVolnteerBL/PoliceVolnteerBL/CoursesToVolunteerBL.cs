    ...
    public class CoursesToVolunteerBL
    {
        ...
        public CoursesToVolunteerBL(string PhoneNumber, int CourseCode, bool isNew)
        {
            ...
            else
            {
                ...
                searchParams.Enqueue(new FieldValue<CoursesToVolunteerField>(CoursesToVolunteerField.PhoneNumber, PhoneNumber, 2));
                searchParams.Enqueue(new FieldValue<CoursesToVolunteerField>(CoursesToVolunteerField.CourseCode, CourseCode.ToString(), 1));
